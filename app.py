...
os.environ["TEMP"] = "/kaggle/working/tmp"
os.environ["TMP"] = "/kaggle/working/tmp"
...
quantize_(pipe2.text_encoder, Int8WeightOnlyConfig())
quantize_(pipe2.transformer, Float8DynamicActivationFloat8WeightConfig())
quantize_(pipe2.transformer_2, Float8DynamicActivationFloat8WeightConfig())
